...
if __name__ == '__main__':
    ...
    parser.add_argument("--events",default="mininet/minievents.json", help="json file with event descriptions")
    args = parser.parse_args()
    setLogLevel('info')
    net = Minievents(topo=SingleSwitchTopo(k=2), switch=OVSKernelSwitch, controller=RemoteController, events_file=args.events)
    net.start()
    CLI(net)